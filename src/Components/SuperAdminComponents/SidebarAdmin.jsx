...
import MenuSideSuperAdmin from "./MenuSideSuperAdmin";

const SidebarAdmin = ({ isSidebarCollapsed, onToggleSidebar, isSidebarVisible ,  onLinkClick}) => {
  return (
    <aside
      className={`fixed z-50 lg:relative custom-scrollbar overflow-y-auto top-0 left-0 h-screen bg-secoundColor text-white transition-all duration-300 
    ...
    >
      ...
      {/* Sidebar Menu */}
      <div className="p-4">
        <MenuSideSuperAdmin onLinkClick={onLinkClick} // Pass the link click handler here
